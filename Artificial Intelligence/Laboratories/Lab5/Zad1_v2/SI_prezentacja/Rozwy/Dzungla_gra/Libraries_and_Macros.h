...
const int MAX_NMOVES = 20000;
const int WORST_SCENARIO = INT_MIN + 1;
const int BEST_SCENARIO = INT_MAX - 1;
...
const pair<pair<int,int>,pair<int,int>> emptyPP = {emptyP,emptyP};


const vector <pair <int,int>> dxy{{-1,0},{0,1},{1,0},{0,-1}};

const vector< vector<char>> obstacles  {{'.','.','#','*','#','.','.'},
                                        {'.','.','.','#','.','.','.'},
                                        {'.','.','.','.','.','.','.'},
                                        {'.','~','~','.','~','~','.'},
                                        {'.','~','~','.','~','~','.'},
